...
image_dir = "D:/plateData/projectPlate/noMergedInfo/CA/usefulImgs/CA"
label_dir = "D:/plateData/projectPlate/noMergedInfo/CA/Labels/CA"
...
def main():
	for label_file in os.listdir(label_dir):
		...
		for warp_id in range(warp_times):
			...
			dst_img_show=dst_img.copy()

			for random_corner in cur_corners_random:
				x=random_corner[0]
				y=random_corner[1]
				cv2.circle(dst_img_show,(x,y),2,(0,255,0),3)
			...
			# cv2.imshow("dst_img_show", dst_img_show)
